...
module Api
  module V1
    class FidsInstallationsController < Api::BaseController
      before_action :set_installation, only: [:show, :update, :destroy]

      # GET /api/v1/fids_installations
      def index
        @installations = FidsInstallation.includes(:user)
                                          .ransack(params[:q])
                                          .result
      ...
      # GET /api/v1/fids_installations/:id
      def show
        render json: { data: serialize_installation(@installation) }
      end

      # POST /api/v1/fids_installations
      def create
      ...
      # PATCH/PUT /api/v1/fids_installations/:id
      def update
      ...
      # DELETE /api/v1/fids_installations/:id
      def destroy
      ...
      def set_installation
        ...
        render_not_found('FIDS Installation not found')
      end

      def installation_params
        params.require(:fids_installation).permit(
